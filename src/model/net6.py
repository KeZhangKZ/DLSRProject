...
class MYNET6(nn.Module):
    def __init__(self, args, conv=default_conv):
        ...
        self.brm = nn.ModuleList([brm(feat=feat, scale=scale, isLast=True if i == self.n_resgroups - 1 else False) for i in range(self.n_resgroups)])
