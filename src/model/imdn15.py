...
class IMDN15(nn.Module):
    def __init__(self, args, num_modules=6):
        super(IMDN15, self).__init__()
        feat = args.n_feats
        scale = args.scale[0]
        ...
        #     nn.PReLU()
        # )
        self.fea_conv = conv_layer(args.n_colors, feat, kernel_size=5)
        ...
        self.upsampler = pixelshuffle_block(feat, args.n_colors, upscale_factor=scale)
